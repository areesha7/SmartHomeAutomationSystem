...
// // Helper functions from Automations file for filtering devices
...
//   // Fetches devices and filters them to only this user's home rooms (same logic as Automations)
...
//       // 2. Get rooms for this home → build roomIdSet
...
//       // If no rooms, user has no devices
...
//     // Reset on user change so previous user's data never shows
//     setDevices([]);
//     setEvents([]);

//     const init = async () => {
//       await fetchDevices(tok);
//       await fetchEvents();
//     };
//     init();
...
//     }, 30000);
//     return () => clearInterval(id);
//   }, [token, fetchDevices, fetchEvents]);
