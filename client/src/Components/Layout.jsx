...
//             <li className="nav-item mb-2">
//               <Link to="/automations" className="nav-link text-white custom-nav-link">
//                 Automations
//               </Link>
//             </li>
...
import { Link } from "react-router-dom";
import { Settings, Bell, ChevronUp, LogOut, LogIn, UserPlus } from "lucide-react";
import Logo from "../assets/noBgLogo.png";
        ...
        <div className="sidebar" style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <div ref={logoutRef} style={{ position: "relative" }}>
              {logoutOpen && (
                <div style={popup}>
                  <Link to="/login" onClick={() => setLogoutOpen(false)}
                    style={popupLink({ borderBottom: "1px solid #f0f0f0" })}
                    onMouseEnter={e => e.currentTarget.style.background = "#fff5f5"}
                    onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                    <div style={iconBox("#fee8e8")}><LogIn size={16} color="#c03030" strokeWidth={2} /></div>
                    Login
                  </Link>
                  <Link to="/signup" onClick={() => setLogoutOpen(false)}
                    style={popupLink()}
                    onMouseEnter={e => e.currentTarget.style.background = "#fff5f5"}
                    onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                    <div style={iconBox("#fee8e8")}><UserPlus size={16} color="#c03030" strokeWidth={2} /></div>
                    Sign Up
                  </Link>
                </div>
              )}
              <button onClick={toggleLogout} style={triggerBtn(logoutOpen)}>
                ...
                <div style={{ flex:1, textAlign:"left" }}>
                  ...
                  <p style={{ margin:0, fontSize:"11px", opacity:0.75, lineHeight:1.3 }}>Login / Sign Up</p>
                </div>
                <ChevronUp size={15} color="white" strokeWidth={2} style={{
